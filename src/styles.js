const styles = {
	...
	heroHeadText:
		'p-2 font-black text-white lg:text-[80px] sm:text-[50px] xs:text-[40px] text-[40px] lg:leading-[98px] xs:leading-[50px] mt-2 text-white underline line-clamp-1 xs:gap-0',
